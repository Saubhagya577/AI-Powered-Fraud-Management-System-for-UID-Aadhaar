...
Biometric Face Match: Uses OpenCV (LBPH Face Recognizer) to match the photo on the ID card with a live webcam feed or uploaded user photo.
Data Extraction & QR Validation: Extracts text using PaddleOCR and cross-references it with the decoded QR Code data for consistency.
